 ...
 */
public interface TypeSafeContainer<K,V> {
	/**
	 ...
	 */
	V get(K id, boolean unfix) throws NoSuchElementException;
	 ...
	 * @throws NoSuchElementException if the desired object is not found.
	 */
	V get(K id) throws NoSuchElementException;
	 ...
	 *         found.
	 */
	Iterator<V> getAll(Iterator<K> ids, final boolean unfix) throws NoSuchElementException;
	 ...
	 *         found.
	 */
	Iterator<V> getAll(Iterator<K> ids) throws NoSuchElementException;
	 ...
	 */
	K insert(V object, boolean unfix);
	 ...
	 *         the input iterator.
	 */
	Iterator<K> insertAll(Iterator<V> objects, final boolean unfix);
	 ...
	 *         the input iterator.
	 */
	Iterator<K> insertAll(Iterator<V> objects);
	 ...
	 *         container.
	 */
	FixedSizeConverter<K> objectIdConverter();
	 ...
	 */
	void remove(K id) throws NoSuchElementException;
	 ...
	 */
	void removeAll(Iterator<K> ids) throws NoSuchElementException;
	...
	*/
	K reserve(Function getObject);
	// K reserve(Supplier<V> getObject); // with Java8 functional interface
	// TODO: choose one
	 ...
	 */
	void unfix(K id) throws NoSuchElementException;
	 ...
	 *         isn't used by the container.
	 */
	void unfixAll(Iterator<K> ids) throws NoSuchElementException;
	 ...
	 */
	void update(K id, V object, boolean unfix) throws NoSuchElementException;
	 ...
	 *         <tt>id</tt> does not exist in the container.
	 */
	void update(K id, V object) throws NoSuchElementException;
	 ...
	 */
	void updateAll(Iterator<K> ids, final Function<K,V> function, boolean unfix) throws NoSuchElementException;
	// with Java8 functional interfaces: 
	// void updateAll(Iterator<K> ids, final java.util.function.Function<K,V> function, boolean unfix) throws NoSuchElementException; 
	// TODO: choose one
	 ...
	 *         of <tt>ids</tt> does not exist in the container.
	 */
	void updateAll(Iterator<K> ids, Function<K,V> function) throws NoSuchElementException;
	// void updateAll(Iterator<K> ids, java.util.function.Function<K,V> function) throws NoSuchElementException;
	 ...
	 *         of <tt>ids</tt> does not exist in the container.
	 */
	void updateAll(Iterator<K> ids, Iterator<V> objects, boolean unfix) throws NoSuchElementException;
	 ...
	 *         of <tt>ids</tt> does not exist in the container.
	 */
	void updateAll(Iterator<K> ids, Iterator<V> objects) throws NoSuchElementException;
	...
	// this might bring problems with generics...
}
