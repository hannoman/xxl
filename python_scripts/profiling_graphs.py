...
# execute_dir = r"""C:\Users\krappel.INFORMATIK\eclipse-git\xxl_dk_fork""" # @uni
...
plot_scatter_times(tree_times, ax, marker="o", color="blue")
plot_scatter_times(comp_times, ax, marker="s", color="red")
